...
## function for debug
def visualize_pts_open3d(xyz, rgb=None, filename=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="exp/scannetv2/pointgroup/pointgroup_run1_scannet/result/epoch384_nmst0.3_scoret0.09_npointt100",
    )
    ...
    parser.add_argument(
        "--task", help="input / semantic_gt / semantic_pred / instance_gt / instance_pred", default="input"
    )
