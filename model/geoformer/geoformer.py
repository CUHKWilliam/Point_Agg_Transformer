...
class GeoFormer(nn.Module):
    ...
    def generate_proposal(
        ...
        cls_logits_pred_b = torch.argmax(cls_logits[b, :, 1:], dim=-1) + 1
...
<<<<<<< HEAD
        ...
        batch_input["original_labels"] = batch_input["labels"].clone()
        batch_input["original_instance_labels"] = batch_input["instance_labels"].clone()
