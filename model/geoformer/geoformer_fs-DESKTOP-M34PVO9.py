...
class GeoFormerFS(nn.Module):
    ...
    def forward(self, support_dict, scene_dict, training=True, remember=False, support_feats=None):
        outputs = {}
        ...
        if support_feats is None:
            support_feats = self.process_support(support_dict, training)  # batch x channel
